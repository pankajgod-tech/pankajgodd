...
async def send_start(client: Client, message: Message):
    ...
    buttons = [[
        InlineKeyboardButton("❣️ Developer Pankajlxt", url = "https://t.me/Pankaj978lt")
    ],[
    ...
    await client.send_message(
        ...
        text=f"<b>👋 Hi {message.from_user.mention}, I am Save Restricted Content Bot,Made by pankajlxt I can send you restricted content by its post link.\n\nFor downloading restricted content /login first.\n\nKnow how to use bot by - /help</b>", 

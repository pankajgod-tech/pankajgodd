...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8977379658:AAGiXSlx2hpGVaWvHIZS0TR8XmrdeNQZA58")

# Your API ID from my.telegram.org
API_ID = int(os.environ.get("API_ID", "31548185"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "9b8e357be88601258217bf93e2e9425a")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "6011787019"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "-1003786886311")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://pankajgtd:pankajsaini@cluster0.hvaluti.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
